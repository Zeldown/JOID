...
public class JOIDWindow {
	...
	private void render() {
		...
		final Resource resource = Resource.of("https://pictures.paladium-pvp.fr/shop/offers/offer_halloween_2024.png");
		BlurShader.use(200F, () -> {
			DrawUtils.RESOURCE.drawResource(0, 0, 1440, 570, resource);
		}, new Vector4f(0, 0, 1440, 570));
